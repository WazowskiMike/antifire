...
SECRET_KEY = 'django-insecure-ig7fxy_x!b^m5kf*f9yz%&7zrrcprc(%&5%r=s!5!qtl@^k=c8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['*','противопожарные-двери-мск.рф']
...
WSGI_APPLICATION = 'antifire.wsgi.application'
